...
const TEMPLATES = {
  article: {
    ...
    agents: [
      ...
      { id: 'planner', label: 'Outliner', model: MODELS.sonnet, skills: ['task-planner'], tools: [], reviewPoint: true,
      ...
      { id: 'quality-gate-1', label: 'Quality Check', model: MODELS.opus, tools: [], isQualityGate: true, maxRetries: 2,
      ...
      { id: 'writer', label: 'Writer', model: MODELS.opus, skills: ['copywriting', 'marketing-psychology'], tools: ['execute_code'],
      ...
      { id: 'editor', label: 'Editor', model: MODELS.sonnet, skills: ['copy-editing'], tools: [],
      ...
      { id: 'quality-gate-2', label: 'Final Check', model: MODELS.opus, tools: [], isQualityGate: true, maxRetries: 2,
  ...
  keynote: {
    ...
    agents: [
      ...
      { id: 'planner', label: 'Slide Planner', model: MODELS.sonnet, skills: ['task-planner'], tools: [], reviewPoint: true,
      ...
      { id: 'writer', label: 'Content Writer', model: MODELS.opus, skills: ['copywriting'], tools: ['execute_code'],
  ...
  speech: {
    ...
    agents: [
      ...
      { id: 'planner', label: 'Speech Architect', model: MODELS.sonnet, skills: ['task-planner'], tools: [], reviewPoint: true,
      ...
      { id: 'writer', label: 'Speechwriter', model: MODELS.opus, skills: ['copywriting', 'doc-coauthoring'], tools: [],
