...
// Default model mapping — roles to inference profile IDs.
...
const TEMPLATES = {
  article: {
    ...
    agents: [
      { id: 'researcher', label: 'Researcher', model: "sonnet", skills: ['research-first', 'customer-research'], tools: ['web'],
      ...
      { id: 'planner', label: 'Outliner', model: "sonnet", skills: ['task-planner', 'analysis-framework'], tools: [], reviewPoint: true,
      ...
      { id: 'quality-gate-1', label: 'Quality Check', model: "opus", tools: [], isQualityGate: true, maxRetries: 2, skills: ['copy-editing'],
      ...
      { id: 'writer', label: 'Writer', model: "opus", skills: ['copywriting', 'marketing-psychology', 'doc-coauthoring'], tools: ['execute_code'],
      ...
      { id: 'editor', label: 'Editor', model: "sonnet", skills: ['copy-editing', 'analysis-framework', 'marketing-psychology'], tools: [],
      ...
      { id: 'quality-gate-2', label: 'Final Check', model: "opus", tools: [], isQualityGate: true, maxRetries: 2, skills: ['copy-editing'],
      ...
      { id: 'formatter', label: 'Formatter', model: "nova", skills: ['docx'], tools: ['execute_code', 'save_file_locally'],
  ...
  keynote: {
    ...
    agents: [
      { id: 'researcher', label: 'Researcher', model: "sonnet", skills: ['research-first'], tools: ['web'],
      ...
      { id: 'planner', label: 'Slide Planner', model: "sonnet", skills: ['task-planner', 'analysis-framework'], tools: [], reviewPoint: true,
      ...
      { id: 'writer', label: 'Content Writer', model: "opus", skills: ['copywriting', 'marketing-psychology', 'doc-coauthoring'], tools: ['execute_code'],
      ...
      { id: 'formatter', label: 'Slide Creator', model: "nova", skills: ['pptx'], tools: ['execute_code', 'save_file_locally'],
  ...
  speech: {
    ...
    agents: [
      ...
      { id: 'planner', label: 'Speech Architect', model: "sonnet", skills: ['task-planner', 'analysis-framework'], tools: [], reviewPoint: true,
      ...
      { id: 'writer', label: 'Speechwriter', model: "opus", skills: ['copywriting', 'doc-coauthoring', 'marketing-psychology'], tools: [],
